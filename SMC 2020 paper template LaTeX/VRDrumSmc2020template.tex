...
\end{abstract}
%Removed all VR, VRMI in order not to have abbreviations in the abstract
...
\begin{figure}[t]
\includegraphics[width=1.0\columnwidth]{SMC 2020 paper template LaTeX/Images/user.png}
